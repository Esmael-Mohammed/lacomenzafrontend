...
import Image3 from '../../assets/category/bu.png'
    ...
    <div className='py-8'>
        <div className='container'>
            ...
            lg:grid-cols-4 gap-8'>
                ...
                {/* second-col  */}
                <div className='py-10 pl-5 bg-gradient-to-br
                from-brandYellow/90 to-brandYellow/90 text-white rounded-3xl
                relative h-[320px] flex items-end'>
                    <div>
                        <div className='mb-4'>
                ...
                from-primary/90 to-primary/90 text-white rounded-3xl
                relative h-[320px] flex items-end'>
                    <div>
                        <div className='mb-4'>
                            <p className='mb-[2px] text-white'>Enjoy</p>
                            <p className='text-2xl font-semibold mb-[2px]'>With</p>
                            <p className='text-4xl xl:text-5xl font-bold opacity-40 mb-2'>Apartment</p>
                            <Button
                            text="Browse"
                            bgColor={"bg-white"}
