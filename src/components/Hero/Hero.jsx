...
const Hero = () => {
  ...
  return (
    ...
    sm:min-h-[650px] 
     hero-bg-color flex justify-center 
     items-center'>
                ...
                <div key={data.id}>
                    ...
                    <div className='order-1 sm:order-2'>
                        <div >
                            ...
                            className='w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] sm:scale-105 lg:scale-110 object-contain mx-auto drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)]
                            relative z-40'/>
                        </div>
                    </div>
                    </div>
